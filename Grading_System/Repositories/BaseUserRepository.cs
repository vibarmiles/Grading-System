...
{
    public class BaseUserRepository : BaseRepository, IUser
    {
        private string connectionString;
        private string fname, mname, lname, username, password, gender, position;

        public BaseUserRepository(string connectionString, string tableOrView, string key) : base(connectionString, tableOrView, key)
        {
